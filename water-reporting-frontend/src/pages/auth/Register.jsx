...
const Register = () => {
    ...
    return (
        <div className="w-full min-h-screen flex animate-in fade-in duration-700 bg-white relative">
            ...
            <div
                className="fixed inset-0 z-0 lg:hidden bg-cover bg-center bg-no-repeat"
                style={{
                    backgroundImage: `url('https://images.unsplash.com/photo-1546255152-4a005086d790?q=80&w=2070&auto=format&fit=crop')`
                }}
            >
